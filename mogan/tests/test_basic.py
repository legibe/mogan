import unittest
from ..tools.basic import time_in_seconds, big_number, big_number_short
...
class TestBasic(unittest.TestCase):
    ...
    def test_time_in_seconds00(self):
        self.evaluate(0)

    def test_time_in_seconds01(self):
        self.evaluate(1)

    def test_time_in_seconds02(self):
        self.evaluate(2)

    def test_time_in_seconds03(self):
        self.evaluate(3)

    def test_time_in_seconds04(self):
        self.evaluate(4)

    def test_time_in_seconds05(self):
        self.evaluate(5)

    def test_time_in_seconds06(self):
        self.evaluate(6)

    def test_time_in_seconds07(self):
        self.evaluate(7)

    def test_time_in_seconds08(self):
        self.evaluate(8)

    def test_time_in_seconds09(self):
        self.evaluate(9)
